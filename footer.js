// footer.js - Official IG Embed with Compact/Smaller Sizing for La Libre
...
(function() {
    ...
    const styles = `
        <style>
            ...
            .ig-section {
                max-width: 380px; /* Reduced container width to scale down the widget */
                margin: 0 auto 1.2rem auto; 
                text-align: center;
            }
            .ig-title {
                font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif;
                font-size: 0.65rem; /* Slightly smaller text for better hierarchy */
            ...
            /* Protective wrapper to constrain and center the Meta iframe */
            .ig-embed-container {
                display: flex;
            ...
            .ig-embed-container blockquote {
                ...
                width: 100% !important;
                max-width: 380px !important; /* Forces the official widget to snap to a smaller profile */
            }
            
            /* Copyright Line - Anchored at the absolute bottom */
            .footer-bottom {
                max-width: 380px;
